...
public class HourlyWeather implements Parcelable {
    ...
    public String toString() {
        ...
        SimpleDateFormat format = new SimpleDateFormat("EEE, MMM d - hh:mm a", Locale.getDefault());
        ...
        return "Hourly Weather: {"
                ...
                + "\n\t" + "apparentTemperature: " + (apparentTemperature() == null ? "---" : apparentTemperature().getValue() + " " + apparentTemperature().getUnit())
